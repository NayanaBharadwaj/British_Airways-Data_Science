...
### Files
- `BA_Lounge_Submission_Final.xlsx` — Official template completed 
   with lookup table + written justification
- `BA_Lounge_Eligibility_Model_v2.xlsx` — Full model with 
   assumptions sheet and tier reference
- `BA_Lounge_Justification_v2.docx` — 8-section written 
...
- `BA_Task2_PredictiveModel.pptx` — Executive summary slide deck
...
- Upload `BA_DataScience_JobSimulation_Completion_Certificate.pdf`
- Click **Commit changes**

---

### Step 7 — Pin the repository to your profile
- Go to your GitHub profile page (github.com/your-username)
- Click **"Customize your pins"**
- Tick `british-airways-data-science`
- Click **Save pins**

It will now appear prominently at the top of your GitHub profile — the first thing any recruiter sees when they visit.

---

### Step 8 — Copy your repo link
Your repository URL will be:
```
https://github.com/your-username/british-airways-data-science
